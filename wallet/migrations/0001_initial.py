...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('currency', models.CharField(choices=[('BTC', 'Bitcoin'), ('ETH', 'Ethereum'), ('LTC', 'Litecoin')], max_length=10)),
        ...
        migrations.AddIndex(
            model_name='wallet',
            index=models.Index(fields=['user', 'currency'], name='wallet_wall_user_id_098bf8_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['timestamp'], name='wallet_tran_timesta_f9e589_idx'),
        ),
    ]
